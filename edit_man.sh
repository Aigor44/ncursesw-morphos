...
TERMINFO="/work/opt/ncursesw/share/terminfo"
...
(*.[0-9]*)
	...
	if test ! -f "/Work/home/aigor/workspace/ncursesw-morphos/man_alias.sed" ; then
cat >>/Work/home/aigor/workspace/ncursesw-morphos/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /Work/home/aigor/workspace/ncursesw-morphos/man_alias.sed"
	fi
	...
	aliases=`sed -f "$top_srcdir/man/manlinks.sed" "$inalias" |sed -f "/Work/home/aigor/workspace/ncursesw-morphos/man_alias.sed" | sort -u; test "$inalias" = "$nCurses" && echo curses`
	...
	sed	-f "/Work/home/aigor/workspace/ncursesw-morphos/man_alias.sed" \
		< "$i" >$TMP
